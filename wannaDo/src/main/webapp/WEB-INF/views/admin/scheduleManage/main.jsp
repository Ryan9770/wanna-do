...
<main>
		<div class="body-container p-4">	
			...
			<div class="body-main shadow">
				<div class="row">
					<div class="col-sm-1 p-0 text-center category-btn">
...
document.addEventListener('DOMContentLoaded', function() {
	...
	calendar = new FullCalendar.Calendar(calendarEl, {
		...
		events: function(info, successCallback, failureCallback) {
			...
			var url ="${pageContext.request.contextPath}/admin/scheduleManage/month";
...
$(function(){
	...
	$(".btnScheduleDelete").click(function() {
		...
		var num = $(this).attr("data-num");
		var url = "${pageContext.request.contextPath}/admin/scheduleManage/delete";
		var query = "num="+num;
...
$(function(){
	...
	$(".btnCategoryAddOk").click(function(){
		...
		var url="${pageContext.request.contextPath}/admin/scheduleManage/categoryAdd";
	...
	$("body").on("click", ".category-item-delete", function(){
		...
		var url="${pageContext.request.contextPath}/admin/scheduleManage/categorydelete";
		var fn = function(data) {
			if(data.state === "true") {
