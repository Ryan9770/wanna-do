...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/vendor/fullschedule5/lib/main.min.css">

<div class="container">
	<div class="body-container">	
		<div class="body-title">
			<h3><i class="bi bi-schedule-event"></i> 일정관리 </h3>
		</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/vendor/fullschedule5/lib/main.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/vendor/fullschedule5/lib/locales-all.min.js"></script>
...
document.addEventListener('DOMContentLoaded', function() {
	...
	schedule = new FullSchedule.Schedule(scheduleEl, {
		headerToolbar: {
...
$(function(){
	...
	$(".btnScheduleDelete").click(function(){
		...
		var fn = function(data) {
			var event = schedule.getEventById(num);
			event.remove();
