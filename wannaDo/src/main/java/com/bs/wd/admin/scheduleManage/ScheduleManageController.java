...
@Controller("admin.scheduleManage.scheduleManageController")
...
public class ScheduleManageController {
	...
	public ModelAndView main(
		...
		ModelAndView mav = new ModelAndView(".admin.scheduleManage.main");
	...
	public String writeForm(@ModelAttribute(value = "dto") Schedule dto,
		...
		return ".admin.scheduleManage.write";
	}
	...
	public String writeSubmit(Schedule dto,
		...
		return "redirect:/admin/scheduleManage/main";
	}
